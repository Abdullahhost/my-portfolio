...
const AboutMe = () => {
    ...
    return (
        <section className="w-full pt-12 px-8 md:pt-40 md:px-20  bg-white">
            ...
            <div className="flex flex-wrap lg:flex-nowrap  gap-16 justify-between ">
                ...
                <div className="px-0 lg:px-[5vw]">
                    ...
                    <p className="text-[4vw]  leading-normal md:leading-9 md:text-[3vw] lg:text-[1.9vw] lg:leading-[3vw] xl:leading-[2.5vw] " >
                        ...
                        We are Expert in full-stack MERN development, focusing on performance, scalability, and exceptional user experiences.

                    </p>
                    <div className={`${showDetails ? " h-[250px]" : "h-0"} transition-all duration-700 relative overflow-hidden w-full`}>

                        <p className={`${showDetails ? "text-md" : "text-[50px]"} absolute top-0 left-0 w-full h-full mt-10 pointer-events-none transition-all duration-700`}> As a passionate MERN stack developer, We specialize in crafting dynamic, high-performance web applications.

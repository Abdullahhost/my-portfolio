    ...
    return (
        <section className="w-full pt-12 px-8 md:pt-40 md:px-20  bg-white">
            <div className="px-0 lg:px-[5vw]">
                <h2 className="relative text-[10vw] py-8 lg:pb-24 leading-9 md:text-[7vw] lg:text-[3.9vw]">
            ...
            <div className="flex flex-wrap lg:flex-nowrap  gap-16 justify-between ">
                ...
                <div className="px-0 lg:px-[5vw]">
                    ...
                    <p className="text-[6vw]  leading-normal md:leading-9 md:text-[3vw] lg:text-[1.9vw]" >

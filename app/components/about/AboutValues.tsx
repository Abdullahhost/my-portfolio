        ...
        <div className='w-full text-white bg-black  controlLargeScreen p-4 md:p-8 lg:p-12 lg:pb-24'>
            ...
            <div className='w-full grid grid-cols-1 lg:grid-cols-2 gap-4'>
                ...
                <div className="p-4 lg:p-6 border cursor-pointer bgGradientForValueBox transition-all border-slate-500">
                    ...
                    <h3 className='text-md md:2xl text-3xl my-3'>Integrity</h3>
                    <p className="my-3" >Lorem ipsum, dolor sit amet consectetur adipisicing elit. Non labore error blanditiis dolorem odit aperiam quam asperiores magnam! Reprehenderit quae modi, mollitia excepturi eius delectus sunt. Consequatur illo et delectus!</p>
                </div>
            </div>
        </div>
